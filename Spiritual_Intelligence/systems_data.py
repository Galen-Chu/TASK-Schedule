...
SYSTEMS_CONFIG = [
    {
        ...
        "harmony_note": "【系統綜合調和與心流指引】薦骨回應是心流的錨點。流日閘門的能量透過身體流動最為順暢——以 10,000 步物理接地、晚間讓身體放空的習慣活動，實現身心合一。",
    },
    {
        "id": "SYS_AST",
    ...
    },
    {
        ...
        "harmony_note": "【系統綜合調和與心流指引】順應流日五行氣場調整節奏：相生之日穩健推進、相剋之日蓄勢養晦。以萬步行走與充足睡眠接地修復，實現生活與事業的雙重豐盛。",
    },
    {
        "id": "SYS_ICHING",
