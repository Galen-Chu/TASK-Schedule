...
座右銘出處（PDF 版面統一不顯示來源，僅於此註記）：
  SYS_LIUYAO 「觀乎天文…化成天下」——《易經・賁卦・彖傳》
  SYS_TAROT  「命運不是被預測的…」——塔羅通行格言
  其餘五術為本報告原創固定金句（2026-09-08 定稿）。
"""
...
SYSTEMS_CONFIG = [
    {
        ...
        "what": "流日太陽閘門點亮之處，即當日集體能量的主題——它落在你圖上開放的區域時感受格外強烈。辨認「這是流日的課題，不是我的本質」，是覺察的第一步。",
        ...
        "harmony_note": "系統調和與心流指引｜薦骨回應是心流的錨點。流日閘門的能量透過身體流動最為順暢——以 10,000 步物理接地、晚間讓身體放空的習慣活動，實現身心合一。",
    },
    {
        "id": "SYS_AST",
        ...
        "harmony_note": "系統調和與心流指引｜月亮回歸是一月中情緒能量最為穩定舒暢的時刻。將水火六分的敏捷動能投注於專案突破，午後則享受金木三分帶來的和諧對話與閱讀滋養，實現理智與感性的完美和諧。",
    },
    {
        "id": "SYS_ZW",
        ...
        "harmony_note": "系統調和與心流指引｜天機化祿與紫微化科帶來強大的智性力量。保持謙遜與務實，將這股靈變的智慧注入代碼自動化與專案規劃中，並在晚間進行日記歸納與感謝記錄，為今日成果畫下完滿句點。",
    },
    {
        "id": "SYS_BAZI",
        ...
        "motto": "「五行流轉各有其時，氣場順逆皆為功課；辨明生剋、順勢而為，腳踏實地自有厚報。」",
        "spotlight": "📍 丁未流日 (火土相生) / 正財透干 / 未土藏乙木食神滋養",
        "system_data_summary": "當日干支：丁未 | 十神：正財當權、食神生財 | 五行動能：火土和諧相生",
        "dimensions": [
            ("維度 A：心理狀態 (靈魂諮商師)", "流日日干與日支的生剋關係決定情緒基調；生扶則心情平穩踏實，剋洩則宜深呼吸放慢節奏，展現沉穩氣度。"),
        ...
        "what": "流日日柱的五行組合決定當日氣場基調——生扶日主則順暢踏實，剋洩日主則需調整節奏；十神透干提示當日的行動導向。",
        ...
        "harmony_note": "系統調和與心流指引｜順應流日五行氣場調整節奏：相生之日穩健推進、相剋之日蓄勢養晦。以萬步行走與充足睡眠接地修復，實現生活與事業的雙重豐盛。",
    },
    {
        "id": "SYS_ICHING",
        ...
        "motto": "「感應天地，虛中受人；體用相生之時順勢而為，相剋之時反身修德。」",
        ...
        "harmony_note": "系統調和與心流指引｜《澤山咸》卦帶來真誠與和諧的感應能量。保持「虛中受人」的謙遜心態，將這股感應力量注入身心覺察與職場溝通中，反身修德，自然能駕馭一切變化並獲得深層成長。",
    },
    {
        "id": "SYS_LIUYAO",
        ...
        "motto": "「觀乎天文以察時變，觀乎人文以化成天下。」",   # 出處《易經・賁卦・彖傳》
        ...
        "harmony_note": "系統調和與心流指引｜易經六爻與八字、紫微共享干支根基，三者形成「天時」的三重驗證。當六爻動爻與八字五行、紫微四化指向一致時，是最佳行動時機。",
    },
    {
        "id": "SYS_TAROT",
        ...
        "harmony_note": "系統調和與心流指引｜塔羅以西方原型心理學視角，與東方易經、紫微形成跨文化對話。當塔羅與六爻的指引方向一致時，是強烈的行動信號。",
    },
]
